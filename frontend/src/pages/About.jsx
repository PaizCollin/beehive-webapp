...
const About = () => {
  ...
  const stmts = [
    ...
    [
      "More Information",
      "Github: https://github.com/paizcollin/beehive-webapp Research Document: https://drive.google.com/file/d/1Ble9ErteABF_nTk1ISFajrWrM6_Eq5KN/view?usp=sharing",
    ],
    [
      "Special Thanks to",
      "Gerhard and Lisa Eschelbeck, Wendy Mather, and Kian Nikzad",
    ],
  ];
